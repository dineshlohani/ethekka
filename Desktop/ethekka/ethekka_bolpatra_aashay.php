...
<?php include("menuincludes/topwrap.php"); ?>
    <div id="body_wrap_inner">
        <div class="maincontent" >
            <h2 class="headinguserprofile">विषय:- बोलपत्र स्वीकृती गर्ने आशयको सूचना ।<a href="<?=$link?>" class="btn">पछि जानुहोस </a></h2>
            <div class="OurContentFull" >
                <form method="get" action="ethekka_bolpatra_aashay_print.php?>" target="_blank" >
                    ...
                    <div class="userprofiletable" id="div_print">
                        <div class="printPage">
                            ...
                            <div class="printContent">
                                ...
                                <div class="subject">   <u>विषय:- बोलपत्र स्वीकृती गर्ने आशयको सूचना ।</u></div><br>
                                ...
                                <div class="myspacer20"></div>
                                <div class="text-center"><strong><u>तपशिल</u></strong></div>
                                <div class="myspacer"></div>
