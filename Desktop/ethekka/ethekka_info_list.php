...
class Ethekkainfo
{
  protected static $table_name = "ethekka_info_list";
  protected static $db_fields = array('id','plan_id','firm_name',
            'firm_address','bolpatra_miti','bolpatra_m','contact_no','dharauti_no','thekka_no','place_to_organize','thekka_rakam','kabol_rakam','print_date','bank_name','bank_address','bank_amount','bank_date','dharauti_amt','dharauti_miti');
            
                        public $id;
                        public $plan_id ;
						public $bolpatra_miti;
						public $bolpatra_m;
                        public $firm_name ;
                        public $firm_address ;
                        public $contact_no ;
